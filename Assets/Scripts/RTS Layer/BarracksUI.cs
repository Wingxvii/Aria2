...
namespace RTSInput
{
    ...
    public class BarracksUI : MonoBehaviour
    {
        ...
        private static BarracksUI _instance;
        public static BarracksUI Instance { get { return _instance; } }
        private void Awake()
        {
        ...
        private void Update()
        {
            ...
            if (InputManager.Instance.PrimaryEntity != null && InputManager.Instance.PrimaryEntity.type == EntityType.Barracks && InputManager.Instance.SelectedEntities.Count == 1)
            {
                UIParent.SetActive(true);
                if (parentSelected != (Barracks)InputManager.Instance.PrimaryEntity)
                {
                    parentSelected = (Barracks)InputManager.Instance.PrimaryEntity;
                }
                UpdateQueue();
            }
            else
